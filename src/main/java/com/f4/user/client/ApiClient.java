...
import com.f4.user.client.auth.HttpBasicAuth;
import com.f4.user.client.auth.HttpBearerAuth;
import com.f4.user.client.auth.ApiKeyAuth;
import com.f4.user.client.ApiResponseDecoder;
...
public class ApiClient {
  ...
  private String basePath = "/services/mscommentlike";
